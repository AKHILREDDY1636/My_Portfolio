var internships = [
  ...
  "Completed internship in Amazon (Amazon Development Center, Hyderabad) for durationof 3months. During this internship, I contributed my work for FINTECH team,one of most efficient" +
    "and crucial team in Developing Teams. <ul><li> Developed internal site using ReactJS.</li><li> Developed an automatic tool in which all the business reports will be directly connectedto WorkDocs.</li></ul> ",
];
